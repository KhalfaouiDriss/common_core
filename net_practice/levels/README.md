...
1. **Open the training interface**  
   Open `index.html` in your web browser to access the interactive training environment.

2. **Navigation and exercises**  
...
# Resources
- Networking references used in this project:  
  - TCP/IP addressing and subnetting guides  
  - Default gateway configuration tutorials  
  - Routers and switches setup documentation  
  - OSI model overviews and layer explanations  
